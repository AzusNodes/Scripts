...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='azus.conf'
CONFIGFOLDER='/root/.azus'
COIN_DAEMON='azusd'
COIN_CLI='azus-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/AzusNodes/AZUS/releases/download/v1.0.0/azus-1.0.0-Ubuntu16.04-daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='azusd'
COIN_EXPLORER='http://explorer.azusnodes.com/'
COIN_PORT=50322
RPC_PORT=50323
